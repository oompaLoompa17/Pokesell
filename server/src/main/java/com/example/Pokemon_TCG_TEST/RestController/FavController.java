...
//         }
//         String email = auth.getName();
//         List<String> favorites = userService.getAllFavourites(email);
//         List<Card> favoriteCards = cardService.getCardsByIds(favorites);
//         return ResponseEntity.ok(Map.of("data", favoriteCards)); // Wrap list in JSON
//     }
...
//                     .body(Map.of("message", "Invalid card ID."));
//         }
//         boolean added = userService.addFavourite(email, cardId);
//         return added ? ResponseEntity.ok(Map.of("message", "Card added to favorites!"))
//                      : ResponseEntity.status(HttpStatus.CONFLICT)
//                              .body(Map.of("message", "Card is already in favorites."));
//     }
...
//                     .body(Map.of("message", "Invalid card ID."));
//         }
//         userService.removeFavourite(email, cardId);
//         return ResponseEntity.ok(Map.of("message", "Card removed from favorites!"));
//     }
// }